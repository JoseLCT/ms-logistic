...
public class OrderTest {
	...
	public void Create_WithValidData_ShouldSucceed() {
		...
		DateTime scheduledDate = DateTime.UtcNow.Date.AddDays(1);
		string address = "Av. San Martin 123";
		GeoPointValue location = CreateValidGeoPoint();
	...
	public void Create_WithPastDate_ShouldThrowDomainException() {
		...
		DateTime pastDate = DateTime.UtcNow.Date.AddDays(-1);
