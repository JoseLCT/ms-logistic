...
public class RouteTest {
	...
	public void Create_WithValidParameters_ShouldSucceed() {
		...
		GeoPointValue originLocation = CreateValidGeoPoint();
	...
	public void AssignDriver_WhenPending_ShouldAssignDriver() {
		// Arrange
		Route route = CreateValidRoute(driverId: null);
		var driverId = Guid.NewGuid();
	...
	public void Start_WhenPendingWithDriver_ShouldStartAndRaiseEvent() {
		...
		RouteStarted startedEvent = route.DomainEvents.OfType<RouteStarted>().Single();
	...
	public void Cancel_WhenPending_ShouldCancelAndRaiseEvent() {
		...
		RouteCancelled cancelledEvent = route.DomainEvents.OfType<RouteCancelled>().Single();
