...
public class RemoveCustomerHandler : IRequestHandler<RemoveCustomerCommand, Result> {
	...
	public async Task<Result> Handle(RemoveCustomerCommand request, CancellationToken ct) {
